            ...
            <Card className="w-full max-w-2xl">
                ...
                <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <Button variant="secondary" className="h-24 flex flex-col items-center justify-center" onClick={handleOpen}>
                            <FolderOpen className="h-6 w-6 mb-2" />
                            Open existing project
                        </Button>
                        <Button className="h-24 flex flex-col items-center justify-center" onClick={() => setIsCreateOpen(true)}>
