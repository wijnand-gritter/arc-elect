          ...
          completionProviderRef.current = monacoInstance.languages.registerCompletionItemProvider(
            'json',
            {
              ...
              provideCompletionItems: (model, position) => {
                ...
                if (propertyMatch) {
                  ...
                  const schemaKeywords = [
                    ...
                    },
                    {
                      ...
                      documentation: 'Detailed description of the schema purpose',
                    },
                    {
                      label: 'required',
                      detail: 'Required properties',
                      documentation: 'Array of property names that must be present',
                    },
                    {
                      label: 'properties',
                      detail: 'Schema properties',
                      documentation: 'Defines the properties of an object schema',
                    },
                    {
                      label: 'items',
                      detail: 'Array items',
                    ...
                    },
                    {
                      label: 'enum',
                      detail: 'Enumeration',
                      documentation: 'Restricts values to a specific set of options',
                    },
                    {
                      label: 'const',
                      detail: 'Constant value',
                      documentation: 'The value must exactly match this constant',
                    },
                    {
                      label: 'format',
                    ...
                    },
                    {
                      ...
                      documentation: 'String must have at least this many characters',
                    },
                    {
                      label: 'maxLength',
                      detail: 'Maximum length',
                      documentation: 'String must have at most this many characters',
                    },
                    {
                      label: 'minItems',
                      detail: 'Minimum items',
                      documentation: 'Array must have at least this many elements',
                    },
                    {
                      label: 'maxItems',
                      detail: 'Maximum items',
                      documentation: 'Array must have at most this many elements',
                    },
                    {
                      label: 'uniqueItems',
                      detail: 'Unique items',
                    ...
                    },
                    {
                      ...
                      documentation: 'Whether to allow properties not defined in schema',
                    },
                    {
                      label: 'allOf',
                      detail: 'All of',
                      documentation: 'Value must validate against ALL of these schemas',
                    },
                    {
                      label: 'anyOf',
                      detail: 'Any of',
                      documentation: 'Value must validate against AT LEAST ONE of these schemas',
                    },
                    {
                      label: 'oneOf',
                      detail: 'One of',
                      documentation: 'Value must validate against EXACTLY ONE of these schemas',
                    },
                    {
                      label: 'not',
                      detail: 'Not',
                      documentation: 'Value must NOT validate against this schema',
                    },
                    {
                      label: 'if',
                      detail: 'If condition',
                      documentation: 'Conditional validation - if this schema validates, then...',
                    },
                    {
                      label: 'then',
                      detail: 'Then',
                    ...
                    },
                    {
                      ...
                      documentation: 'Default value when property is not provided',
                    },
                    {
                      label: 'examples',
                      detail: 'Examples',
                      documentation: 'Sample values that are valid for this schema',
                    },
                    {
                      label: 'deprecated',
                      detail: 'Deprecated',
                    ...
                    },
                    {
                      label: 'readOnly',
                      detail: 'Read only',
                      documentation: 'Property should not be modified by clients',
                    },
                    {
                      label: 'writeOnly',
                      detail: 'Write only',
                      documentation: 'Property should not be returned by servers',
                    },
                  ];
                ...
                return {
                  suggestions: [...suggestions, ...additionalSuggestions, ...snippetSuggestions],
                };
              },
            },
          );
