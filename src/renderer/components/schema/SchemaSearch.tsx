 ...
 * ```
 */
export function SchemaSearch({ isExpanded = false, onToggleExpanded }: SchemaSearchProps): React.JSX.Element {
     ...
     */
    const handleValidationStatusChange = useCallback((value: string) => {
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={searchFilters.validationStatus} onValueChange={handleValidationStatusChange}>
                                    <SelectTrigger>
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select value={searchFilters.sortDirection} onValueChange={handleSortDirectionChange}>
                                    <SelectTrigger>
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
